...
export function AudioVisualCta() {
  ...
  return (
    <section id="consultation" ref={sectionRef} className="relative overflow-hidden bg-[#1E1A1C] py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-balance text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
            Ready to modernize your meeting and signage experience?
          </h2>
          <p className="mt-6 text-lg leading-relaxed text-gray-300 sm:text-xl">
            Partner with UTEC for design, deployment, and support—aligned with your IT and security roadmap.
          </p>
        </div>
