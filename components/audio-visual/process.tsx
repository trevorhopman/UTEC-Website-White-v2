...
const steps = [
  {
    ...
    icon: Search,
    title: "Assess",
    description: "Survey rooms, usage patterns, acoustics, network paths, and display inventory",
  },
  {
    number: "02",
    icon: Lightbulb,
    title: "Recommend",
    description: "Room standards, UC platform alignment, signage strategy, and phased budget",
  },
  {
    number: "03",
    icon: Settings,
    title: "Implement",
    description: "Install, integrate, commission, and train—minimizing disruption to operations",
  },
  {
    number: "04",
    icon: Headphones,
    title: "Support",
    description: "Monitoring, break-fix, firmware updates, and continuous optimization",
  },
]

export function AudioVisualProcess() {
